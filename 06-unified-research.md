...
- [Сводная таблица: все решения](#сводная-таблица-все-решения)
  - [Tier 1 — серьёзные кандидаты](#tier-1--серьёзные-кандидаты-deep-dive-проведён)
  - [Tier 2 — нишевые или менее зрелые](#tier-2--нишевые-или-менее-зрелые)
  - [Tier 3 — не подходят](#tier-3--не-подходят-лицензия-или-модель)
- [Honcho Mechanism Coverage Matrix](#honcho-mechanism-coverage-matrix)
- [Decision Matrix](#decision-matrix)
- [Detailed Profiles](#detailed-profiles)
  - [Honcho](#honcho) · [EverMemOS](#evermemos) · [Hindsight](#hindsight) · [Letta](#letta) · [Memobase](#memobase) · [Microsoft Foundry Memory](#microsoft-foundry-memory) · [Memori](#memori) · [Cognee](#cognee) · [Graphiti](#graphiti) · [MemOS](#memos) · [Mem0](#mem0) · [A-MEM](#a-mem)
